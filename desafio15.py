...
ir = salario_no_mes * 0.11
inss = salario_no_mes * 0.08
sindicato = salario_no_mes * 0.05
impostos_totais = ir + inss + sindicato
salario_liquido = salario_no_mes - impostos_totais

print (salario_no_mes)
print (ir)
print (inss)
print (sindicato)
